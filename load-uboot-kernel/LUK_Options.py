...
class _Options():
    ...
    def set( self, args ):
        ...
        parser.add_option('--dhcp', help='Use dhcp to get the ipadd and serverip automatically, you can change DHCP in config file', action='store_true', dest='dhcp', default=False )
